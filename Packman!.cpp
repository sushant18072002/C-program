...
int main()
{
        //clrscr();
		// i
		 int i=0,j=0,ii=0,iii=0,lm=0; // int l=0,m=0,n=0,o=0,o1=0;
		 int a=44,b=25;
		 int p=0,q=0,r=0,s,h=0,t=0,w=0,x=0,y=8,kkk=0,sss;
				...
				for( i=1;i<=50;i++)
		{
			for(j=1;j<=50;j++)
			{
		      ...
		      else if(i>=22&&j==46&& i<=28 || i>=14&&j==38&& i<=35  ||  j>=38&&i+j==50+24&&j<=46 ||j>=38&&i==j-24&&j<=46 ||
		...
		printf("                        ");
		 ...
		 else if(kk[kkk]=='s'&&y1==0)
		 {
			 a++;
		 }
		else if(kk[kkk]=='a'&&y1==0)
		 {
			 b--;
		 }
		else if(kk[kkk]=='d'&&y1==0)
		 {
			 b++;
		 }
	     	   for( i=1;i<=50;i++)
